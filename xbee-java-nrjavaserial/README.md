# About
This is a fork of the [XBee Java Library](https://github.com/digidotcom/xbee-java) with focus of updating the old [RXTX Library](http://rxtx.qbang.org/) to enable the use in newer JDKs.
